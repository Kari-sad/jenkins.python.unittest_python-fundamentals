...
class Predicator(object):
    def is_greater_than_5(self, some_value):
        return bool(some_value > 5)  # TODO - Implement solution

    def is_greater_than_8(self, some_value):
        return bool(some_value > 8)   # TODO - Implement solution

    def is_less_than_4(self, some_value):
        return bool(some_value < 4)  # TODO - Implement solution

    def is_less_than_1(self, some_value):
        return bool(some_value <1)     # TODO - Implement solution